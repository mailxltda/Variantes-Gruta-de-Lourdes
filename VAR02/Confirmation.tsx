...
const Confirmation = () => {
  ...
  // Carrega o player VTurb no topo da página
  useEffect(() => {
    const playerElement = document.createElement('vturb-smartplayer');
    playerElement.id = 'vid-68dae3c694f41f2dfa2c687c';
    playerElement.style.display = 'block';
    playerElement.style.margin = '0 auto';
    playerElement.style.width = '100%';
    playerElement.style.maxWidth = '400px';

    const container = document.getElementById('confirmation-video-container');
    if (container) {
      container.appendChild(playerElement);
    }

    const script = document.createElement('script');
    script.src = 'https://scripts.converteai.net/50ef5c18-6787-4abc-bbce-c80337f7015d/players/68dae3c694f41f2dfa2c687c/v4/player.js';
    script.async = true;
    ...
    <div className="min-h-screen bg-white text-gray-800 font-sans">
      ...
      <section className="py-8 px-4 bg-white">
        <div className="mx-auto max-w-screen-lg flex justify-center">
          <div id="confirmation-video-container" style={{width: "100%", maxWidth: "400px"}} />
        </div>
      </section>
      {/* Hero Section */}

...
const Index = () => {
  ...
  useEffect(() => {
    ...
    script.src = 'https://scripts.converteai.net/50ef5c18-6787-4abc-bbce-c80337f7015d/players/68dae97694f41f2dfa2c7048/v4/player.js';
    script.async = true;
      ...
      <main>
        ...
        <section className="py-8 px-4 bg-white">
          <div className="mx-auto max-w-screen-lg flex justify-center">
            <div id="home-video-container" style={{width: '100%', maxWidth: '400px'}} />
          </div>
        </section>
